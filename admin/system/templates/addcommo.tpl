...
<table width="720" border="0" cellpadding="0" cellspacing="1">
    <form id="addcommo" name="addcom" enctype="multipart/form-data" method="post" action="addcommo_chk.php" onsubmit="return chkcommo(addcommo)">
        <tr>
        ...
        <tr>
            ...
            <td height="25" align="left" valign="top" class="right">
                <iframe id="menu1" name="menu1" src="menu.php" width="300" height="22" frameborder="0" scrolling="no" style="margin-top: 0px;margin-left: 0px;top:0px;"></iframe>&nbsp;<input id="stype" name="stype" type="hidden"
                value="" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="25" class="right">&nbsp;<input  id="stocks" name="stocks" type="text" value="1" class="txt"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="25" class="right">&nbsp;<input id="fold" name="fold"  value="9" type="text" class="shorttxt" onkeyup="cvp(addcommo)"/>&nbsp;折
                <font color="#FF0000">*</font></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="25" class="right">&nbsp;<textarea rows="8" cols="70" id="info" name="info">暂无介绍</textarea></td>
        </tr>
        <tr>
